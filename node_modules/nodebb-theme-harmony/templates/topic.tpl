			...
			<div class="d-flex flex-column gap-3 flex-grow-1">
				<h1 component="post/header" class="tracking-tight fw-semibold fs-3 mb-0 text-break {{{ if config.theme.centerHeaderElements }}}text-center{{{ end }}}">
					...
					<div class="answered-toggle">
						<!-- Two distinct buttons: 'Answered' and 'Unanswered' -->
						<button id="markAnsweredBtn" class="btn btn-sm btn-link">Answered</button>
						<button id="markUnansweredBtn" class="btn btn-sm btn-link">Unanswered</button>
						{{/if}}
					</div>
				</h1>
