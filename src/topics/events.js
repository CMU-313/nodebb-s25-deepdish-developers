...
Events._types = {
	...
	important: {
		icon: 'fa-star',
		translation: async (event, language) => translateSimple(event, language, 'topic:user-marked-important'),
	},
	unimportant: {
		icon: 'fa-star-o',
		translation: async (event, language) => translateSimple(event, language, 'topic:user-unmarked-important'),
	},
	lock: {
		icon: 'fa-lock',
